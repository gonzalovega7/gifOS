...
function abrirGifosMax() {
    ...
    if (JSON.stringify(arregloFavoritos).includes(JSON.stringify(eventoMax))) {
        document.getElementById("btn-favorite").removeAttribute("class", "far");
        document.getElementById("btn-favorite").setAttribute("class", "fas");
    } else {
        document.getElementById("btn-favorite").removeAttribute("class", "fas");
        document.getElementById("btn-favorite").setAttribute("class", "far");
    }
