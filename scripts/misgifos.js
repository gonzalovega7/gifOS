...
function misgifos() {
    ...
    if (arregloMisGifos.length == 0) {
        document.getElementById("misgif-nocontent").style.display = "block";
...
document.getElementById("recording-area").appendChild(tiempoRepetir);
tiempoRepetir.setAttribute("id", "tiempo-repetir");
document.getElementById("add-gif").addEventListener("click", function() {
    ...
    document.getElementById("record-gif").style.display = "grid";
    document.getElementById("add-gif").setAttribute("class", "active")
});
...
function comenzar() {
    ...
    document.getElementById("step1").classList.add("hover");
    document.getElementById("instructive").innerHTML = "¿Nos das acceso <br/> a tu cámara?";
    document.getElementById("detail").innerHTML = "El acceso a tu camara será válido sólo <br/> por el tiempo en el que estés creando el GIFO."
    getStreamAndRecord();
};
...
function getStreamAndRecord() {
    navigator.mediaDevices.getUserMedia({
        ...
        .then(function(stream) {
            document.getElementById("instructive").style.display = "none";
            document.getElementById("detail").style.display = "none";
            let capturaVideo = document.createElement("video");
            document.getElementById("recording-center").appendChild(capturaVideo);
            ...
            grabar.setAttribute("class", "start");
            grabar.textContent = "GRABAR";
            document.getElementById("step1").classList.remove("hover");
            ...
            function grabacion() {
                ...
                pararGrabacion.setAttribute("class", "start");
...
function stopRecording() {
    ...
    document.getElementById("recording-center").appendChild(imgGif);
    imgGif.src = info;
    document.getElementById("btn-parar").style.display = "none";
    let uploadGif = document.createElement("h4");
    document.getElementById("foot").appendChild(uploadGif);
    uploadGif.setAttribute("id", "uploadGif");
    uploadGif.setAttribute("class", "start");
    uploadGif.textContent = "SUBIR GIFO";
    clearInterval(id);
    ...
    document.getElementById("tiempo-repetir").addEventListener("click", function() {
        ...
        document.getElementById("uploadGif").remove();
        ...
        document.getElementById("instructive").style.display = "block";
        document.getElementById("detail").style.display = "block";
        getStreamAndRecord();
    });
    document.getElementById("uploadGif").addEventListener("click", function() {
        document.getElementById("step2").classList.remove("hover");
        document.getElementById("step3").classList.add("hover");
        ...
        document.getElementById("recording-center").appendChild(loader);
        document.getElementById("recording-center").appendChild(subiendoGifo);
        let hoverCard = document.createElement("div");
        hoverCard.setAttribute("id", "hoverCard");
        document.getElementById("recording-center").appendChild(hoverCard);
        fetch(`https://upload.giphy.com/v1/gifs?api_key=${apiKey}`, { method: "POST", body: form })
            ...
            .then(json => {
                ...
                otroGif.setAttribute("class", "start");
                ...
                document.getElementById("otroGif").addEventListener("click", function() {
                    ...
                    document.getElementById("uploadGif").remove();
                    document.getElementById("videoGif").remove();
                    document.getElementById("step3").classList.remove("hover");
                    document.getElementById("tiempo-repetir").style.visibility = "hidden";
                    document.getElementById("tiempo-repetir").style.borderBottom = "none";
                    document.getElementById("tiempo-repetir").innerHTML = "00:00:00";
                    comenzar();
