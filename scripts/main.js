...
const apiKey = "88FKJE8iKf0T5wFzZa38HJ8qJVPHuszy";
let enter = false;
        ...
        .then(json => {
            ...
            if (document.getElementById("input-srch").value.length != 0) {
                for (i = 0; i < json.data.length; i++) {
                    ...
                    document.getElementById("suggest").appendChild(palabraSug);
    ...
    fetch(apiSearch)
        ...
        .then(json => {
            if (json.data.length !== 0) {
                ...
                document.getElementById("search-noresult").style.display = "none";
                document.getElementById("text-noresult").style.display = "none";
                document.getElementById("more").style.display = "block";
            } else {
                document.getElementById("search-noresult").style.display = "block";
                document.getElementById("text-noresult").style.display = "block";
...
document.getElementById("more").addEventListener("click", verMas);
...
window.onscroll = function() {
    if (screen.width >= desktop) {
        ...
        if (scroll > 10) {
            ...
            document.getElementById("li-add-gif").style.visibility = "hidden";
            ...
            document.getElementById("li-add-gif").style.visibility = "visible";
            document.getElementById("nav-search").style.visibility = "hidden";
        }
    }
}